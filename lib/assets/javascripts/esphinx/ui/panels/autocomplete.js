        ...
        // new: function(searchTextBox, originalList, options = {}, callback) {
            var
                ...
                composeMatch = function(mapped, nodeText,
                    ...
                    nodeTextAsArr.spaceOut().capitalize().forEach(function(value,
                                                                           i) {
                        if (mapped.hasOwnProperty(i)) {
                            ...
                            if (!leftUnitName.empty()) {
                                composedArr.push(window.document.createTextNode(
                                    capitalize(leftUnitName, nodeText)));
                            } else {
                                span.text(capitalize(span.text(), nodeText));
                            }
                ...
                capitalize = function(word, nodeText) {
                    var
                        searchIndex;
                ...
                create = function(referenceNode) {
                    ...
                    if (referenceNode.instanceOf(window.HTMLInputElement)) {
                        ...
                        marginBottom = referenceNode.css("margin-bottom");
                        width = referenceNode.width();
                        borderBottom = referenceNode.css("border-bottom");
            ...
            searchTextBox.autocomplete(originalList, options, function(found,
                                                                       mapped) {
                var
                    resolvedAnswer;
