                    ...
                    var
                                ...
                                if (mapped.hasOwnProperty(i)) {
                                    ...
                                    if (!leftUnitName.empty()) {
                                        composedArr.push(window.document
                                            .createTextNode(capitalize(
                                            leftUnitName,nodeText)));
                                    } else {
                            ...
                            if (referenceNode.instanceOf(window.HTMLInputElement)) {
                                ...
                                $(window.document).on("mouseup", function (e) {
                                    ...
                                    if (!target.instanceOf(window.HTMLInputElement) &&
                                        !target.constructorIs(window.HTMLLIElement)) {
                                        target = target
                                    ...
                                    if (!hitTarget(target)) {
                                        ...
                                        .constructorIs(window.HTMLLIElement)) {
                        ...
                        show = function (autocompletedList) {
                            ...
                            if (searchTextBox.value()) {
                                ...
                                autocompletedList.select(function (li) {
