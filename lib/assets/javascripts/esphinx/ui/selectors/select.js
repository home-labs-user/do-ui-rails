            ...
            Select: {
                ...
                new: function (select, options) {
                    var
                        ...
                        // o objeto caixa de texto teria o método autocomplete, porém, como só há um por select, não é tão necessário adicionar complexidade

                        // TextBox = {
                        //     new: function() {
                        //         var
                        //             ConstructionClass = TextBox;

                        //         if (!(this instanceof ConstructionClass.new)) {
                        //             return new ConstructionClass.new();
                        //         }
                        //     }
                        // },
