            ...
            var
                ...
                composeOptions = function(optionElements) {
                    ...
                    if (searchTextBox.value() ||
                        ...
                        abstractOptions = [];
                    } else if (originalAbstractOptions) {
                        abstractSelect.append(originalAbstractOptions.clone());
                    }
                },
                ...
                compose = function() {
                    ...
                    originalAbstractOptions = abstractSelect.childElements()
                        .clone();
