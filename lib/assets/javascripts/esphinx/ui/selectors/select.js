        ...
        new: function(select, options) {
            var
                ...
                toggleCaptionClass = function(caption) {
                    caption.toggleClass("arrow-expanded", "arrow-retracted");
                },
                ...
                decorate = function() {
                    ...
                    var
                        attachEventListenerOnFoundList = function(
                            abstractOptions) {
                        ...
                        decorateOptions = function(optionElements) {
                            ...
                            attachEventListenerOnFoundList(abstractOptions);
                            abstractOptions = [];
                        },
            ...
            $(window.document).on("click", function(e) {
                ...
                if (!$(e.target).parent(CSS_CLASS_QUERY + ".select").some()) {
            ...
            this.addOption = function(option) {
                // testar se existe no select antes de adicioná-la a ele
