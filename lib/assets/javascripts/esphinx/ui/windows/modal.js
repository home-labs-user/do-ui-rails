            ...
            modal: {
                ...
                new: function (contentSource, options) {
                            ...
                            main.observe(function (observer) {
                                ...
                                if (imgs.any()) {
                                    ...
                                    FlowControl.new({
                                        ...
                                        ready: function () {
                                            // agora já não há mais controle para exibir, estando tão somente na mão do usuário, portanto o método show deve ser melhorado
                    ...
                    this.show = function () {
                        ...
                        if (imgs.any()) {
                            imgs.each(function (img) {
                                if (!imagesLoaded.indexPerEquivalence(img)) {
                                    $(img).on("load", function (e) {
                                        count += 1;
                                    });
                                } else {
