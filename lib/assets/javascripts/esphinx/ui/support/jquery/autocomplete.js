                    ...
                    obj.sortByTextContent(order).each(function (i, domObj) {
                        ...
                        for (i in arrTextBoxContent) {
                            if (arrTextBoxContent.hasOwnProperty(i)) {
                                ...
                                // para colocar span em todas as string, todas devem ser iteradas, ou seja, iterar sobre arrDomObjText para fazer searchIndex. Mas isso não deve ser necessário, pois ele deve se ater a primeira correspondência, pois já basta
                                if (searchIndex !== -1) {
                                    countFound += 1;
