...
(function ($) {
    ...
    // transformar em um objeto js o select e o tooltip, seguindo o modelo do modal ao invés de um método para o jQuery. Porém não será necessário guardar em singleton, já que não será destruído
    $.prototype.buildOptions = function (args) {
        ...
        var
            ...
            buildOpts = function (jqObj) {
                ...
                captionText = wrapper
                    .find(".esphinx-ui-caption-box .esphinx-ui-caption-text");
            ...
            toggleCaptionClass = function (jqObj) {
                jqObj.toggleClass("esphinx-ui-arrow-expanded",
                    "esphinx-ui-arrow-retracted");
            },
                ...
                jqObj.each(function (i, select) {
                    ...
                    searchTextBox.autocomplete(options, args.search,
                        function (found, e) {
                            ...
                            target = $(e.target);
                            optionsBox = target
                                .closest(".esphinx-ui-options-box");
                            options = optionsBox.find("ul.esphinx-ui-list li");
