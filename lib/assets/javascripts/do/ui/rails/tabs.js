...
(function ($) {
    ...
    var
        ...
        checkAnchors = function (params) {
            ...
            nav = params.navigator;
                ...
                debugger
                if (!nav.length) {
                params.navigator.each(function (i, o) {
                    anchor = $("<a></a>");
                    $(o).append(anchor);
                    if ($(o).attr("id")) {
    ...
    $.tabsController = function (params) {
        ...
        if (params) {
            ...
            // if (nav) {
            //     debugger
            //     if (nav.prop("tagName") !== "A" && nav.prop("tagName") !== "NAV") {
            //         // creates nav
            //         // nav = nav .closest("nav");
            //         // if (!nav.length) {
            //         //     nav = $("<nav></nav>");
            //         //     ul = params.navigator.closest("ul");
            //         //     ul.parent().prepend(nav);
            //         //     $(nav).append(ul);
            //         // }
            //         // nav.addClass("do-ui-tabs-nav");
