...
(function ($namespace) {
    ...
    var
        showContentOnload = function (jqObj, selectedClassName) {
            var
            ...
            if (URLHash.isSet()) {
                ...
                handle = items.find("a." + selectedClassName);
            }
            id = handle.attr("href");
        ...
        selectTabOnload = function (jqObj, selectedClassName) {
            var
        ...
        selectTab = function (handle, selectedClassName) {
    ...
    $namespace.tabsNav = function (jqObj) {
