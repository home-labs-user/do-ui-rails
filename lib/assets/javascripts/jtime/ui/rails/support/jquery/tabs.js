(function ($) {
    ...
    var
        tabsNavPrepare = function (nav, args) {
            var
                parent,
                tabs,
                tab,
            ...
            nav.addClass("jtime-ui-tabs-nav");
            ...
            tabs.each(function (i, o) {
                ...
                anchor.attr("id", "jtime-ui-tab-nav-" + (i + 1));
        ...
        selectTab = function (handle, args) {
            ...
            tabs.find("a").removeClass("jtime-ui-tab-selected");
            target.addClass("jtime-ui-tab-selected");
        ...
        tabContainerPrepare = function (args) {
            var
                items = args.container.find("li.jtime-ui-tabs-container-option"),
                li;
            items.each(function (i, o) {
                li = $(o);
                li.attr("data-parent-tab", "jtime-ui-tab-nav-" + (i + 1));
            });
        },
        ...
        showContent = function (handle, args) {
            ...
            args.container.find("li.jtime-ui-tabs-container-option").hide();
    ...
    $.prototype.setTabs = function (args) {
        var
            self = $(this),
            container;
        ...
        if (args) {
            ...
            if (args.container) {
                ...
                container.addClass("jtime-ui-tabs-container");
                container.find("li").addClass("jtime-ui-tabs-container-option");
                tabContainerPrepare(args);
