...
jQuery.fn.build = function () {
    ...
    selects.each(function (i, select) {
        ...
        // setActionToSelect(select);
    });
    //pegar o pai do select, criar o custom-select, por causa do css

}

var buildOpts = function (jqSelect) {
    "use strict";

    var
        wrapper = jqSelect.closest('.custom-select')
...
var toggleCaptionClass = function (jqSelect) {
    "use strict";
    jqSelect.toggleClass('expanded', 'retracted');
}
